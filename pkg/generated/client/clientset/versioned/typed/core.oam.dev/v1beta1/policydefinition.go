...
func (c *policyDefinitions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.PolicyDefinition, err error) {
	result = &v1beta1.PolicyDefinition{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *policyDefinitions) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.PolicyDefinitionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.PolicyDefinitionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("policydefinitions").
...
func (c *policyDefinitions) Create(ctx context.Context, policyDefinition *v1beta1.PolicyDefinition, opts v1.CreateOptions) (result *v1beta1.PolicyDefinition, err error) {
	result = &v1beta1.PolicyDefinition{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("policydefinitions").
...
func (c *policyDefinitions) Update(ctx context.Context, policyDefinition *v1beta1.PolicyDefinition, opts v1.UpdateOptions) (result *v1beta1.PolicyDefinition, err error) {
	result = &v1beta1.PolicyDefinition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("policydefinitions").
...
func (c *policyDefinitions) UpdateStatus(ctx context.Context, policyDefinition *v1beta1.PolicyDefinition, opts v1.UpdateOptions) (result *v1beta1.PolicyDefinition, err error) {
	result = &v1beta1.PolicyDefinition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("policydefinitions").
...
func (c *policyDefinitions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.PolicyDefinition, err error) {
	result = &v1beta1.PolicyDefinition{}
