...
var workloaddefinitionsResource = schema.GroupVersionResource{Group: "core.oam.dev", Version: "v1beta1", Resource: "workloaddefinitions"}

var workloaddefinitionsKind = schema.GroupVersionKind{Group: "core.oam.dev", Version: "v1beta1", Kind: "WorkloadDefinition"}
...
func (c *FakeWorkloadDefinitions) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.WorkloadDefinitionList, err error) {
	...
	list := &v1beta1.WorkloadDefinitionList{ListMeta: obj.(*v1beta1.WorkloadDefinitionList).ListMeta}
	for _, item := range obj.(*v1beta1.WorkloadDefinitionList).Items {
