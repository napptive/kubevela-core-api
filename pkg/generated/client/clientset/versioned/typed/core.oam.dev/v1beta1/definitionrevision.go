...
func (c *definitionRevisions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.DefinitionRevision, err error) {
...
func (c *definitionRevisions) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.DefinitionRevisionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.DefinitionRevisionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("definitionrevisions").
...
func (c *definitionRevisions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *definitionRevisions) Create(ctx context.Context, definitionRevision *v1beta1.DefinitionRevision, opts v1.CreateOptions) (result *v1beta1.DefinitionRevision, err error) {
	result = &v1beta1.DefinitionRevision{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("definitionrevisions").
...
func (c *definitionRevisions) Update(ctx context.Context, definitionRevision *v1beta1.DefinitionRevision, opts v1.UpdateOptions) (result *v1beta1.DefinitionRevision, err error) {
	result = &v1beta1.DefinitionRevision{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("definitionrevisions").
...
func (c *definitionRevisions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *definitionRevisions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *definitionRevisions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.DefinitionRevision, err error) {
	result = &v1beta1.DefinitionRevision{}
